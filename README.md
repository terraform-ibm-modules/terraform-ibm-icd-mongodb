...
| <a name="input_disk_mb"></a> [disk\_mb](#input\_disk\_mb) | Disk space available to the database instance. The disk space available to the member group must fall within the range of 1024 to 4194304, in increments of 1024. | `number` | `20480` | no |
