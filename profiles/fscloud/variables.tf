...
variable "region" {
  description = "The region mongodb is to be created on. The region must support BYOK ( us-south, us-east, and eu-de)"
  type        = string
  default     = "us-south"
  validation {
    condition = anytrue([
...
variable "instance_name" {
  description = "Name of the new mongodb instance"
  type        = string
}
